  ...
  return (
    <div className="ml-60 p-8 bg-gray-100 min-h-screen">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            {/* Followers */}
            <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200 cursor-pointer transition duration-500 hover:scale-[1.02]">
            ...
            <div className="flex items-center gap-4">
                ...
                <h2 className="text-3xl font-bold text-gray-800">980</h2>
                </div>
            </div>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                <p className="text-gray-500 text-sm">Total Hobbies</p>
